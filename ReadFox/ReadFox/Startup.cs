...
namespace ReadFox
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                option.LoginPath = new Microsoft.AspNetCore.Http.PathString("/Account/Index/");
                option.AccessDeniedPath = new Microsoft.AspNetCore.Http.PathString("/Account/ErrorForbidden/");
